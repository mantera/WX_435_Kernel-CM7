...
*
*BC 2011-10-26
*Changed the default fifo_batch and rev_penalty to 1 to better suit nand flash memory, and set the scheduler up to run with SSTF(Shortest Seek Time First)
*
*/
